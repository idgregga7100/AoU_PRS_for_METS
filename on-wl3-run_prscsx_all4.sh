...
--sst_file=/home/isabelle/PRSCSx/snp-gwas/GWAS-bmi_AoU_training_${pop1}_scaled_${pheno}.sumstats.txt,/home/isabelle/PRSCSx/snp-gwas/GWAS-bmi_AoU_training_${pop2}_scaled_${pheno}.sumstats.txt,/home/isabelle/PRSCSx/snp->
--n_gwas=$n1,$n2,$n3 \
--pop=${pop1^^},${pop2^^},${pop3^^} \
--phi=${phi} \
--out_dir=${mydir}prscsx_out_allAoU_METS756_bim/ \
--out_name=AoU_scaled_${pheno} \
--chrom=1,8,9,16,17 \
--seed=777
#done
